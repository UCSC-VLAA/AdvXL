...
from timm.utils import get_state_dict, unwrap_model, state_dict_tp_fp32
...
class TrainState:
    ...
    def state_dict(self, unwrap_fn=unwrap_model):
        state = dict(
            ...
            model=state_dict_tp_fp32(get_state_dict(self.model, unwrap_fn)),
            model_ema=None if self.model_ema is None else state_dict_tp_fp32(get_state_dict(self.model_ema, unwrap_fn)),
