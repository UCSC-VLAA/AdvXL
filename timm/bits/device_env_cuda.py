    ...
    def __post_init__(
        ...
        if self.autocast is None:
            ...
            if self.precision == 'amp':
                ...
                self.amp = True
            elif self.precision == 'amp_bfloat16' or self.precision == 'amp_bf16':
                self.autocast = lambda: torch.cuda.amp.autocast(dtype=torch.bfloat16)
                self.amp = True
            else:
