...
def setup_model_and_optimizer(
    ...
    if isinstance(optimizer, Callable):
        ...
        optimizer = optimizer(model.base_model, **optimizer_cfg) if isinstance(model, AdvModel) else optimizer(model, **optimizer_cfg)
    else:
        optimizer = create_optimizer_v2(model.base_model, **optimizer_cfg) if isinstance(model, AdvModel) else create_optimizer_v2(model, **optimizer_cfg)
