...
from timm.adversarial.autoattack.other_utils import L0_norm, L1_norm, L2_norm
from timm.adversarial.autoattack.checks import check_zero_gradients
...
class APGDAttack():
    ...
    def attack_single_run(self, x, y, x_init=None):
        ...
        # initialize step_size. 2 x epsilon in linf
