...
from timm.adversarial.autoattack import checks
from timm.adversarial.autoattack.state import EvaluationState
...
class AutoAttack():
    ...
    def run_standard_evaluation(self,
        ...
        # instead, return robust accuracy here (or robust_flags)
        # if return_labels:
        #     return x_adv, y_adv
        # else:
        #     return x_adv
